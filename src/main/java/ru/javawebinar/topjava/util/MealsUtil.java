...
public class MealsUtil {
    ...
    static {
        ...
        MEALS.add(new Meal(LocalDateTime.of(2015, Month.MAY, 30, 10, 0), "Завтрак2", 500));
        MEALS.add(new Meal(LocalDateTime.of(2015, Month.MAY, 30, 13, 0), "Обед2", 1000));
        MEALS.add(new Meal(LocalDateTime.of(2015, Month.MAY, 30, 20, 0), "Ужин2", 500));
        MEALS.add(new Meal(LocalDateTime.of(2015, Month.MAY, 31, 10, 0), "Завтрак2", 1000));
        MEALS.add(new Meal(LocalDateTime.of(2015, Month.MAY, 31, 13, 0), "Обед2", 500));
        MEALS.add(new Meal(LocalDateTime.of(2015, Month.MAY, 31, 20, 0), "Ужин2", 510));
